                ...
                <form id="formData">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" placeholder="Nama Kelas" required>
                        </div>
                    </div>
